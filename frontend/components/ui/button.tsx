...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-xl text-sm font-medium transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:ring-offset-background disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 cursor-pointer",
  {
    variants: {
      variant: {
        default:
          "bg-primary text-primary-foreground shadow-[var(--shadow-clay)] hover:bg-primary/90 active:shadow-[var(--shadow-clay-inset)] active:translate-y-px",
        secondary:
          "bg-secondary text-secondary-foreground shadow-[var(--shadow-clay-sm)] hover:bg-secondary/80 active:shadow-[var(--shadow-clay-inset)]",
        destructive:
          "bg-destructive text-destructive-foreground shadow-[var(--shadow-clay-sm)] hover:bg-destructive/90 active:shadow-[var(--shadow-clay-inset)]",
        outline:
